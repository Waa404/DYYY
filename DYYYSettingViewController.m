...
- (void)setupSettingsData {
    self.settingsData = [NSMutableArray arrayWithArray:@[
        ...
        [@{
            ...
            @"expanded": @NO,
            @"items": [self loadSettingsForSection:@[
                @{@"title": @"启用评论文字改色", @"type": @"switch", @"value": @NO, @"key": @"WaaEnableCommentColor"},
                @{@"title": @"自定评论文字颜色", @"type": @"input", @"value": @"", @"key": @"WaaCommentColor", @"placeholder": @"十六进制"},
                @{@"title": @"调整评论区透明度", @"type": @"input", @"value": @"", @"key": @"WaaCommentTransparency", @"placeholder": @"0-1小数"},
                @{@"title": @"调整输入框透明度", @"type": @"input", @"value": @"", @"key": @"WaaInputBoxTransparency", @"placeholder": @"0-1小数"},
                @{@"title": @"隐藏视频评论背景", @"type": @"switch", @"value": @NO, @"key": @"WaaHideChatCommentBg"},
                @{@"title": @"隐藏双指清屏进度", @"type": @"switch", @"value": @NO, @"key": @"WaaHidePurityRrogress"},
                @{@"title": @"启用主页视频全屏", @"type": @"switch", @"value": @NO, @"key": @"WaaEnableHomeFullScreen"},
                @{@"title": @"修复关注二次确认", @"type": @"switch", @"value": @NO, @"key": @"WaaFollowfix"}
            ]]
        } mutableCopy]
    ]];
}
